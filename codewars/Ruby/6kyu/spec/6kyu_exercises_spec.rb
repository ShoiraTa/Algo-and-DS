...
RSpec.describe "7 kyu codewars" do
  describe 'Test' do
    ...
    it "should pass fixed tests" do
      expect(find_missing_letter(["a","b","c","d","f"])).to eq "e"
      expect(find_missing_letter(["O","Q","R","S"])).to eq "P"
      expect(find_missing_letter(["b","d"])).to eq "c"
      expect(find_missing_letter(["a","b","d"])).to eq "c"
      expect(find_missing_letter(["b","d","e"])).to eq "c"
    end
